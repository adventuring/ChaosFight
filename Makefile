...
Dist/$(GAME).NTSC.a26 Dist/$(GAME).NTSC.sym Dist/$(GAME).NTSC.lst: \
	...
	sed 's/TV_STANDARD/NTSC/g' Source/Common/AssemblyWrapper.template.s > Source/Generated/$(GAME).NTSC.s
...
Dist/$(GAME).SECAM.a26 Dist/$(GAME).SECAM.sym Dist/$(GAME).SECAM.lst: \
	...
	sed 's/TV_STANDARD/SECAM/g' Source/Common/AssemblyWrapper.template.s > Source/Generated/$(GAME).SECAM.s
