...
Dist/$(GAME).NTSC.a26 Dist/$(GAME).NTSC.sym Dist/$(GAME).NTSC.lst: \
	...
	@printf "          include \"Source/Common/AssemblyConfig.s\"\n" >> Source/Generated/$(GAME).NTSC.s
	@printf "          include \"Source/Common/AssemblyConfig.NTSC.s\"\n" >> Source/Generated/$(GAME).NTSC.s
	@printf "          include \"Source/Generated/$(GAME).NTSC.body.s\"\n" >> Source/Generated/$(GAME).NTSC.s
	@printf "          include \"Source/Common/AssemblyFooter.s\"\n" >> Source/Generated/$(GAME).NTSC.s
...
Dist/$(GAME).PAL.a26 Dist/$(GAME).PAL.sym Dist/$(GAME).PAL.lst: \
	...
	@printf "          include \"Source/Common/AssemblyConfig.PAL.s\"\n" >> Source/Generated/$(GAME).PAL.s
	@printf "          include \"Source/Generated/$(GAME).PAL.body.s\"\n" >> Source/Generated/$(GAME).PAL.s
	@printf "          include \"Source/Common/AssemblyFooter.s\"\n" >> Source/Generated/$(GAME).PAL.s
...
Dist/$(GAME).SECAM.a26 Dist/$(GAME).SECAM.sym Dist/$(GAME).SECAM.lst: \
	...
	@printf "          include \"Source/Common/AssemblyConfig.SECAM.s\"\n" >> Source/Generated/$(GAME).SECAM.s
	@printf "          include \"Source/Generated/$(GAME).SECAM.body.s\"\n" >> Source/Generated/$(GAME).SECAM.s
	@printf "          include \"Source/Common/AssemblyFooter.s\"\n" >> Source/Generated/$(GAME).SECAM.s
