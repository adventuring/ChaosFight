...
Dist/$(GAME).NTSC.a26 Dist/$(GAME).NTSC.sym Dist/$(GAME).NTSC.lst: \
	...
	@echo "; ChaosFight - Generated assembly wrapper for $(GAME) NTSC" > Source/Generated/$(GAME).NTSC.s
	@echo "; This file is automatically generated - do not edit" >> Source/Generated/$(GAME).NTSC.s
	@echo "" >> Source/Generated/$(GAME).NTSC.s
	@echo "include \"Source/Common/AssemblyConfig.s\"" >> Source/Generated/$(GAME).NTSC.s
	@echo "include \"Source/Common/AssemblyConfig.NTSC.s\"" >> Source/Generated/$(GAME).NTSC.s
	@echo "include \"Source/Generated/$(GAME).NTSC.body.s\"" >> Source/Generated/$(GAME).NTSC.s
	@echo "include \"Source/Common/AssemblyFooter.s\"" >> Source/Generated/$(GAME).NTSC.s
...
Dist/$(GAME).PAL.a26 Dist/$(GAME).PAL.sym Dist/$(GAME).PAL.lst: \
	...
	@echo "; ChaosFight - Generated assembly wrapper for $(GAME) PAL" > Source/Generated/$(GAME).PAL.s
	@echo "; This file is automatically generated - do not edit" >> Source/Generated/$(GAME).PAL.s
	@echo "" >> Source/Generated/$(GAME).PAL.s
	@echo "include \"Source/Common/AssemblyConfig.s\"" >> Source/Generated/$(GAME).PAL.s
	@echo "include \"Source/Common/AssemblyConfig.PAL.s\"" >> Source/Generated/$(GAME).PAL.sdicts
	@echo "include \"Source/Generated/$(GAME).PAL.body.s\"" >> Source/Generated/$(GAME).PAL.s
	@echo "include \"Source/Common/AssemblyFooter.s\"" >> Source/Generated/$(GAME).PAL.s
...
Dist/$(GAME).SECAM.a26 Dist/$(GAME).SECAM.sym Dist/$(GAME).SECAM.lst: \
	...
	cd Object && ../bin/postprocess -i $(POSTINC) < bB 영화.asm | ../bin/optimize > ../Source/Generated/$(GAME).SECAM.body.s
	@echo "; ChaosFight - Generated assembly wrapper for $(GAME) SECAM" > Source/Generated/$(GAME).SECAM.s
	@echo "; This file is automatically generated - do not edit" >> Source/Generated/$(GAME).SECAM.s
	@echo "" >> Source/Generated/$(GAME).SECAM.s
	@echo "include \"Source/Common/AssemblyConfig.s\"" >> Source/Generated/$(GAME).SECAM.s
	@echo "include \"Source/Common/AssemblyConfig.SECAM.s\"" >> Source/Generated/$(GAME).SECAM.s
	@echo "include \"Source/Generated/$(GAME).SECAM.body.s\"" >> Source/Generated/$(GAME).SECAM.s
	@echo "include \"Source/Common/AssemblyFooter.s\"" >> Source/Generated/$(GAME).SECAM.s
