          rem ChaosFight - Source/Banks/Bank0.bas
          ...
          bank 0
          asm
            ;; "Start of data" is at CPU space $F100 in Bank 0:            ;; Since RORG $F000 is active, Bank 0:file space $0000-$0FFF maps to CPU $F000-$FFFF
          ...
          asm
Bank1DataStart
            echo "Bank 0:data starts at ", .
BuildInfoStart
end
          include "Source/Common/BuildInfo.s"
          asm
BuildInfoEnd
            echo "// Bank 0: ", [BuildInfoEnd - BuildInfoStart]d, " bytes = BuildInfo"
SongPointers1Start
end
...
#include "Source/Data/SongPointers1.bas"
          asm
SongPointers1End
            echo "// Bank 0: ", [SongPointers1End - SongPointers1Start]d, " bytes = SongPointers1"
end

          rem Song Data (Bank 1)
          rem Song IDs hosted here: Bank0MinSongID-28 (currently 7-28) - character themes plus admin screen music
          rem Songs 0-Bank14MaxSongID reside in Bank 15

          rem Character theme songs (IDs Bank0MinSongID-25)
...
#include "Source/Generated/Song.LowRes.PAL.bas"
          ...
          asm
LowResSongEnd
            echo "// Bank 0: ", [LowResSongEnd - LowResSongStart]d, " bytes = Song.LowRes"
RoboTitoSongStart
end
...
#include "Source/Generated/Song.RoboTito.PAL.bas"
          ...
          asm
RoboTitoSongEnd
            echo "// Bank 0: ", [RoboTitoSongEnd - RoboTitoSongStart]d, " bytes = Song.RoboTito"
...
SongOfTheBearSongEnd
            echo "// Bank 0: ", [SongOfTheBearSongEnd - SongOfTheBearSongStart]d, " bytes = Song.SongOfTheBear"
DucksAwaySongStart
end
...
#include "Source/Generated/Song.DucksAway.PAL.bas"
          ...
          asm
DucksAwaySongEnd
            echo "// Bank 0: ", [DucksAwaySongEnd - DucksAwaySongStart]d, " bytes = Song.DucksAway"
...
Character16ThemeSongEnd
            echo "// Bank 0: ", [Character16ThemeSongEnd - Character16ThemeSongStart]d, " bytes = Song.Character16Theme"
...
Character17ThemeSongEnd
            echo "// Bank 0: ", [Character17ThemeSongEnd - Character17ThemeSongStart]d, " bytes = Song.Character17Theme"
...
Character18ThemeSongEnd
            echo "// Bank 0: ", [Character18ThemeSongEnd - Character18ThemeSongStart]d, " bytes = Song.Character18Theme"
...
Character19ThemeSongEnd
            echo "// Bank 0: ", [Character19ThemeSongEnd - Character19ThemeSongStart]d, " bytes = Song.Character19Theme"
...
Character20ThemeSongEnd
            echo "// Bank 0: ", [Character20ThemeSongEnd - Character20ThemeSongStart]d, " bytes = Song.Character20Theme"
...
Character21ThemeSongEnd
            echo "// Bank 0: ", [Character21ThemeSongEnd - Character21ThemeSongStart]d, " bytes = Song.Character21Theme"
...
Character22ThemeSongEnd
            echo "// Bank 0: ", [Character22ThemeSongEnd - Character22ThemeSongStart]d, " bytes = Song.Character22Theme"
...
Character23ThemeSongEnd
            echo "// Bank 0: ", [Character23ThemeSongEnd - Character23ThemeSongStart]d, " bytes = Song.Character23Theme"
...
Character24ThemeSongEnd
            echo "// Bank 0: ", [Character24ThemeSongEnd - Character24ThemeSongStart]d, " bytes = Song.Character24Theme"
...
Character25ThemeSongEnd
            echo "// Bank 0: ", [Character25ThemeSongEnd - Character25ThemeSongStart]d, " bytes = Song.Character25Theme"
...
Character26ThemeSongEnd
            echo "// Bank 0: ", [Character26ThemeSongEnd - Character26ThemeSongStart]d, " bytes = Song.Character26Theme"
...
Character27ThemeSongEnd
            echo "// Bank 0: ", [Character27ThemeSongEnd - Character27ThemeSongStart]d, " bytes = Song.Character27Theme"
...
Character28ThemeSongEnd
            echo "// Bank 0: ", [Character28ThemeSongEnd - Character28ThemeSongStart]d, " bytes = Song.Character28Theme"
...
Character29ThemeSongEnd
            echo "// Bank 0: ", [Character29ThemeSongEnd - Character29ThemeSongStart]d, " bytes = Song.Character29Theme"
...
Character30ThemeSongEnd
            echo "// Bank 0: ", [Character30ThemeSongEnd - Character30ThemeSongStart]d, " bytes = Song.Character30Theme"
ChaoticaSongStart
end
...
#include "Source/Generated/Song.Chaotica.PAL.bas"
          ...
          asm
ChaoticaSongEnd
            echo "// Bank 0: ", [ChaoticaSongEnd - ChaoticaSongStart]d, " bytes = Song.Chaotica"
AtariTodaySongStart
end
...
#include "Source/Generated/Song.AtariToday.PAL.bas"
          ...
          asm
AtariTodaySongEnd
            echo "// Bank 0: ", [AtariTodaySongEnd - AtariTodaySongStart]d, " bytes = Song.AtariToday"
...
#include "Source/Generated/Song.Interworldly.PAL.bas"
          ...
          asm
InterworldlySongEnd
            echo "// Bank 0: ", [InterworldlySongEnd - InterworldlySongStart]d, " bytes = Song.Interworldly"
Bank1DataEnds
end
...
#include "Source/Routines/MusicBankHelpers.bas"
          asm
MusicBankHelpersEnd
            echo "// Bank 0: ", [MusicBankHelpersEnd - MusicBankHelpersStart]d, " bytes = MusicBankHelpers"
end
