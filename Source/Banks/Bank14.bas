          ...
          rem Songs stored in Bank 14: IDs 0-Bank14MaxSongID (currently Bernie, OCascadia, Revontuli, EXO, Grizzards, MagicalFairyForce, Bolero)
...
#include "Source/Generated/Song.Bernie.PAL.bas"
          ...
          asm
BernieSongEnd
            echo "// Bank 14: ", [BernieSongEnd - BernieSongStart]d, " bytes = Song.Bernie"
OCascadiaSongStart
end
...
#include "Source/Generated/Song.OCascadia.PAL.bas"
          ...
          asm
OCascadiaSongEnd
            echo "// Bank 14: ", [OCascadiaSongEnd - OCascadiaSongStart]d, " bytes = Song.OCascadia"
RevontuliSongStart
end
...
#include "Source/Generated/Song.Revontuli.PAL.bas"
          ...
          asm
RevontuliSongEnd
            echo "// Bank 14: ", [RevontuliSongEnd - RevontuliSongStart]d, " bytes = Song.Revontuli"
EXOSongStart
end
...
#include "Source/Generated/Song.EXO.PAL.bas"
          ...
          asm
EXOSongEnd
            echo "// Bank 14: ", [EXOSongEnd - EXOSongStart]d, " bytes = Song.EXO"
...
MagicalFairyForceSongEnd
            echo "// Bank 14: ", [MagicalFairyForceSongEnd - MagicalFairyForceSongStart]d, " bytes = Song.MagicalFairyForce"
GrizzardsSongStart
end
...
#include "Source/Generated/Song.Grizzards.PAL.bas"
          ...
          asm
GrizzardsSongEnd
            echo "// Bank 14: ", [GrizzardsSongEnd - GrizzardsSongStart]d, " bytes = Song.Grizzards"
BoleroSongStart
end
...
#include "Source/Generated/Song.Bolero.PAL.bas"
          ...
          asm
BoleroSongEnd
            echo "// Bank 14: ", [BoleroSongEnd - BoleroSongStart]d, " bytes = Song.Bolero"
SoundAttackHitStart
end
...
#include "Source/Generated/Sound.SoundAttackHit.PAL.bas"
          ...
          asm
SoundAttackHitEnd
            echo "// Bank 14: ", [SoundAttackHitEnd - SoundAttackHitStart]d, " bytes = Sound.SoundAttackHit"
...
#include "Source/Generated/Sound.SoundGuardBlock.PAL.bas"
          ...
          asm
SoundGuardBlockEnd
            echo "// Bank 14: ", [SoundGuardBlockEnd - SoundGuardBlockStart]d, " bytes = Sound.SoundGuardBlock"
SoundJumpStart
end
...
#include "Source/Generated/Sound.SoundJump.PAL.bas"
          ...
          asm
SoundJumpEnd
            echo "// Bank 14: ", [SoundJumpEnd - SoundJumpStart]d, " bytes = Sound.SoundJump"
...
SoundPlayerEliminatedEnd
            echo "// Bank 14: ", [SoundPlayerEliminatedEnd - SoundPlayerEliminatedStart]d, " bytes = Sound.SoundPlayerEliminated"
...
SoundMenuNavigateEnd
            echo "// Bank 14: ", [SoundMenuNavigateEnd - SoundMenuNavigateStart]d, " bytes = Sound.SoundMenuNavigate"
...
#include "Source/Generated/Sound.SoundMenuSelect.PAL.bas"
          ...
          asm
SoundMenuSelectEnd
            echo "// Bank 14: ", [SoundMenuSelectEnd - SoundMenuSelectStart]d, " bytes = Sound.SoundMenuSelect"
...
#include "Source/Generated/Sound.SoundSpecialMove.PAL.bas"
          ...
          asm
SoundSpecialMoveEnd
            echo "// Bank 14: ", [SoundSpecialMoveEnd - SoundSpecialMoveStart]d, " bytes = Sound.SoundSpecialMove"
SoundPowerupStart
end
...
#include "Source/Generated/Sound.SoundPowerup.PAL.bas"
          ...
          asm
SoundPowerupEnd
            echo "// Bank 14: ", [SoundPowerupEnd - SoundPowerupStart]d, " bytes = Sound.SoundPowerup"
...
#include "Source/Generated/Sound.SoundLandingSafe.PAL.bas"
          ...
          asm
SoundLandingSafeEnd
            echo "// Bank 14: ", [SoundLandingSafeEnd - SoundLandingSafeStart]d, " bytes = Sound.SoundLandingSafe"
...
SoundLandingDamageEnd
            echo "// Bank 14: ", [SoundLandingDamageEnd - SoundLandingDamageStart]d, " bytes = Sound.SoundLandingDamage"
SoundPointersStart
end
...
#include "Source/Data/SoundPointers.bas"
          asm
SoundPointersEnd
            echo "// Bank 14: ", [SoundPointersEnd - SoundPointersStart]d, " bytes = SoundPointers"
SongPointers2Start
end
#include "Source/Data/SongPointers2.bas"
          asm
SongPointers2End
            echo "// Bank 14: ", [SongPointers2End - SongPointers2Start]d, " bytes = SongPointers2"
Bank15DataEnds
end
...
#include "Source/Routines/LoadSoundPointer.bas"
          asm
LoadSoundPointerEnd
            echo "// Bank 14: ", [LoadSoundPointerEnd - LoadSoundPointerStart]d, " bytes = LoadSoundPointer"
LoadSoundNoteStart
end
#include "Source/Routines/LoadSoundNote.bas"
          asm
LoadSoundNoteEnd
            echo "// Bank 14: ", [LoadSoundNoteEnd - LoadSoundNoteStart]d, " bytes = LoadSoundNote"
LoadSoundNote1Start
end
#include "Source/Routines/LoadSoundNote1.bas"
          asm
LoadSoundNote1End
            echo "// Bank 14: ", [LoadSoundNote1End - LoadSoundNote1Start]d, " bytes = LoadSoundNote1"
UpdateSoundEffectVoice0Start
end
#include "Source/Routines/UpdateSoundEffectVoice0.bas"
          asm
UpdateSoundEffectVoice0End
            echo "// Bank 14: ", [UpdateSoundEffectVoice0End - UpdateSoundEffectVoice0Start]d, " bytes = UpdateSoundEffectVoice0"
UpdateSoundEffectVoice1Start
end
#include "Source/Routines/UpdateSoundEffectVoice1.bas"
          asm
UpdateSoundEffectVoice1End
            echo "// Bank 14: ", [UpdateSoundEffectVoice1End - UpdateSoundEffectVoice1Start]d, " bytes = UpdateSoundEffectVoice1"
PlaySoundEffectStart
end
#include "Source/Routines/PlaySoundEffect.bas"
          asm
PlaySoundEffectEnd
            echo "// Bank 14: ", [PlaySoundEffectEnd - PlaySoundEffectStart]d, " bytes = PlaySoundEffect"
UpdateSoundEffectStart
end
#include "Source/Routines/UpdateSoundEffect.bas"
          asm
UpdateSoundEffectEnd
            echo "// Bank 14: ", [UpdateSoundEffectEnd - UpdateSoundEffectStart]d, " bytes = UpdateSoundEffect"
StopSoundEffectsStart
end
#include "Source/Routines/StopSoundEffects.bas"
          asm
StopSoundEffectsEnd
            echo "// Bank 14: ", [StopSoundEffectsEnd - StopSoundEffectsStart]d, " bytes = StopSoundEffects"
MusicBankHelpers15Start
end
#include "Source/Routines/MusicBankHelpers15.bas"
          asm
MusicBankHelpers15End
            echo "// Bank 14: ", [MusicBankHelpers15End - MusicBankHelpers15Start]d, " bytes = MusicBankHelpers15"
MusicSystemStart
end
#include "Source/Routines/MusicSystem.bas"
          asm
MusicSystemEnd
            echo "// Bank 14: ", [MusicSystemEnd - MusicSystemStart]d, " bytes = MusicSystem"
Bank15CodeEnds
end
