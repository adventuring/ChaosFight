...
Bank16DataEnds
          if Bank16DataEnds > $F100
           echo "// Bank 15: ", [ArenaColorsBWEnd - ArenaColorsBWStart]d, " bytes = ArenaColorsBW"
           echo "// Bank 15: ", [BlankPlayfieldEnd - BlankPlayfieldStart]d, " bytes = BlankPlayfield"
           echo "// Bank 15: ", [BlankPlayfieldColorsEnd - BlankPlayfieldColorsStart]d, " bytes = BlankPlayfieldColors"
           echo "// Bank 15: ", [Arena31PlayfieldEnd - Arena0PlayfieldStart]d, " bytes = 32 Arenas (Arena0-31)"
           echo "// Bank 15: ", [Bank16AfterArenas - ArenaColorsBWStart]d, " bytes = Total Arenas section"
           echo "// Bank 15: ", [Bank16AfterNumbers - Bank16AfterArenas]d, " bytes = Numbers"
           echo "// Bank 15: ", [Bank16AfterPlayerColors - Bank16AfterNumbers]d, " bytes = PlayerColors"
           echo "// Bank 15: ", [Bank16DataEnds - Bank16AfterPlayerColors]d, " bytes = WinnerScreen"
          endif
end
...
#include "Source/Routines/DisplayWinScreen.bas"
          ...
          asm
Bank16CodeEnds
           echo "// Bank 15: ", [Bank16AfterMultiSpriteKernel - Bank16DataEnds]d, " bytes = MultiSpriteKernel"
           echo "// Bank 15: ", [Bank16AfterArenaLoader - Bank16AfterMultiSpriteKernel]d, " bytes = ArenaLoader"
           echo "// Bank 15: ", [Bank16AfterLoadArenaByIndex - Bank16AfterArenaLoader]d, " bytes = LoadArenaByIndex"
           echo "// Bank 15: ", [Bank16AfterMainLoop - Bank16AfterLoadArenaByIndex]d, " bytes = MainLoop"
           echo "// Bank 15: ", [Bank16AfterVblankTrampoline - Bank16AfterMainLoop]d, " bytes = VblankHandlerTrampoline"
           echo "// Bank 15: ", [Bank16AfterSpriteLoader - Bank16AfterMainLoop]d, " bytes = SpriteLoader"
           echo "// Bank 15: ", [Bank16AfterPlayfieldRead - Bank16AfterSpriteLoader]d, " bytes = PlayfieldRead"
           echo "// Bank 15: ", [Bank16AfterSetPlayerGlyph - Bank16AfterPlayfieldRead]d, " bytes = SetPlayerGlyph (unified)"
           echo "// Bank 15: ", [Bank16CodeEnds - Bank16AfterSetPlayerGlyph]d, " bytes = DisplayWinScreen"
end
