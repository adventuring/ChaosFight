...
ArtAtariAgeEnd
            echo "// Bank 8: ", [ArtAtariAgeEnd - ArtAtariAgeStart]d, " bytes = Art.AtariAge"
ArtAtariAgeTextStart
#include "Source/Generated/Art.AtariAgeText.s"
ArtAtariAgeTextEnd
            echo "// Bank 8: ", [ArtAtariAgeTextEnd - ArtAtariAgeTextStart]d, " bytes = Art.AtariAgeText"
ArtChaosFightStart
#include "Source/Generated/Art.ChaosFight.s"
ArtChaosFightEnd
            echo "// Bank 8: ", [ArtChaosFightEnd - ArtChaosFightStart]d, " bytes = Art.ChaosFight"
ArtAuthorStart
#include "Source/Generated/Art.Author.s"
ArtAuthorEnd
            echo "// Bank 8: ", [ArtAuthorEnd - ArtAuthorStart]d, " bytes = Art.Author"
...
TitlescreenColorsEnd
            echo "// Bank 8: ", [TitlescreenColorsEnd - TitlescreenColorsStart]d, " bytes = titlescreen_colors"
...
TitlescreenAsmEnd
            echo "// Bank 8: ", [TitlescreenAsmEnd - TitlescreenAsmStart]d, " bytes = titlescreen.s"
TitleScreenRenderStart
end
#include "Source/Routines/TitleScreenRender.bas"
          asm
TitleScreenRenderEnd
            echo "// Bank 8: ", [TitleScreenRenderEnd - TitleScreenRenderStart]d, " bytes = TitleScreenRender"
CharacterSelectMainStart
end
#include "Source/Routines/CharacterSelectMain.bas"
          asm
CharacterSelectMainEnd
            echo "// Bank 8: ", [CharacterSelectMainEnd - CharacterSelectMainStart]d, " bytes = CharacterSelectMain"
SpriteLoaderCharacterArtStart
end
#include "Source/Routines/SpriteLoaderCharacterArt.bas"
          asm
SpriteLoaderCharacterArtEnd
            echo "// Bank 8: ", [SpriteLoaderCharacterArtEnd - SpriteLoaderCharacterArtStart]d, " bytes = SpriteLoaderCharacterArt"
Bank9CodeEnds
end
