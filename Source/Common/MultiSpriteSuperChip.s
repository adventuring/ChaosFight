...
player0PointerLo = $A2
player0PointerHi = $A3
p0Top = $CF  ;;; WARNING: Shared with temp5 - different contexts (Kernel rendering vs Game logic)
p0Bottom = $A4
p1Bottom = $A5
player1PointerLo = $A6
player2PointerLo = $A7
...
pf2Pointer = $BD
statusBarLength = $BF
aux3 = $BF  ;;; WARNING: Shared with statusBarLength - different contexts (Admin vs Game mode)
lifeColor = $C0
pfScoreColor = $C0  ;;; WARNING: Shared with lifeColor, aux4 - different contexts (Game mode kernel vs Admin mode)
aux4 = $C0  ;;; WARNING: Shared with lifeColor, pfScoreColor - different contexts (Title screen vs Game mode)
p1Display = $cc
lifePointer = $c1
lives = $c2
pfScore1 = $c1  ;;; WARNING: Shared with lifePointer, aux5 - different contexts (Game mode health bars vs Admin mode)
aux5 = $c1  ;;; WARNING: Shared with lifePointer, pfScore1 - different contexts (Title screen vs Game mode)
pfScore2 = $c2  ;;; WARNING: Shared with lives, aux6 - CRITICAL: aux6 must NOT be used for persistent saves (SP corruption bug fixed)
aux6 = $c2  ;;; WARNING: Shared with lives, pfScore2 - CRITICAL: Do NOT use for persistent saves (pfScore2 writes corrupt saved values)
playfieldPos = $C3
repoLine = $ce
pfHeight = $C4
scorePointers = $C5
...
temp3 = $CD
temp4 = $CE
temp5 = $CF  ;;; WARNING: Shared with p0Top - different contexts (Game logic vs Kernel rendering)
temp6 = $D0
temp7 = $D1
score = $D2
;; Kernel variables moved from stack space ($f0-$ff) to safe zero-page locations
pfColorTable = $D3  ;;; WARNING: Shared with aux1, pfheighttable - different contexts (Arena loading vs Admin mode)
aux2 = $D4
spritesort = $D5
spritesort2 = $D6
spritesort3 = $D7
