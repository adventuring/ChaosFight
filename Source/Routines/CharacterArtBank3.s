...
; Character artwork location system for Bank 3 (Characters 0-7 and 16-23)
...
LocateCharacterArtBank3:
    ...
    ; Characters 24-31 also map to 0-7 (replicas, use same sprite data)
    lda temp1
    sec
    sbc #8              ; Subtract 8 to map 8-15 to 0-7
    and #$07            ; Mask to 0-7 range (also works for 24-31 after subtracting 24)
    ...
    lda CharacterSpritePtrLoBank3,y
    sta temp4           ; Store low byte
    lda CharacterSpritePtrHiBank3,y  
