...
LocateCharacterArtBank3:
    ...
    ; Note: temp9 is passed from dispatcher, already 0-7 for Bank 3
    
    ; Set bank to 3
    lda #3
    sta temp6
    
    ; Get base sprite pointer for character (using bank-relative index from temp9)
