...
LocateCharacterArtBank4 .proc
          ...
          ;; lda CharacterFrameMapLBank4,y (duplicate)
          sta temp1
          ;;;;; Store FrameMap low .byte in temp1
          ;; lda CharacterFrameMapHBank4,y (duplicate)
          ;; pha (duplicate)
...
action:
          ...
          ;; tay (duplicate)
          ;;;;; Use as index
          ;; lda CharacterSpriteLBank4,y (duplicate)
          ;; sta temp4 (duplicate)
          ;;;;; Store Frames low .byte in temp4
          ;; lda CharacterSpriteHBank4,y (duplicate)
          ;; sta temp5 (duplicate)
