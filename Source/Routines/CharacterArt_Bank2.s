; ChaosFight - Source/Routines/CharacterArt_Bank2.s
...
; Characters 0-7: Bernie, Curler, Dragonet, EXOPilot, FatTony, Megax, Harpy, KnightGuy
...
AnimationSequenceOffsets_Bank2:
...
LocateCharacterArt_Bank2:
    ...
    lda CharacterSpritePtrLo_Bank2,y
    sta temp4           ; Store low byte
    lda CharacterSpritePtrHi_Bank2,y  
    sta temp5           ; Store high byte
    
    ; Add sequence offset
    ldy temp3           ; Animation sequence as Y
    lda AnimationSequenceOffsets_Bank2,y
    clc
...
.no_carry1:
    ...
    lda AnimationFrameOffsets_Bank2,y
    clc
    adc temp4           ; Add to low byte
    sta temp4
...
SetPlayerCharacterArt_Bank2:
    lda temp1
    ldx temp2
    ldy temp3
    jsr LocateCharacterArt_Bank2
