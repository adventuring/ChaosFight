...
AnimationSequenceOffsets_Bank5:
...
LocateCharacterArt_Bank5:
    ...
    lda CharacterSpritePtrLo_Bank5,y
    sta temp4           ; Store low byte
    lda CharacterSpritePtrHi_Bank5,y  
    sta temp5           ; Store high byte
    
    ; Add sequence offset
    ldy temp3           ; Animation sequence as Y
    lda AnimationSequenceOffsets_Bank5,y
    clc
...
.no_carry1:
    ...
    lda AnimationFrameOffsets_Bank5,y
    clc
    adc temp4           ; Add to low byte
    sta temp4
