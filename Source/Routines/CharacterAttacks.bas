...
BernieAttack
          ...
          gosub PerformMeleeAttack bank13
...
CurlerAttack
          ...
          rem NOTE: PerformMeleeAttack and PerformRangedAttack already
          rem set
          ...
          goto PerformRangedAttack bank13
...
Character17Attack
          rem Character 17 - Basic melee attack
          rem
          rem Input: temp1 = attacker player index (0-3)
          rem
          rem Output: Melee attack executed
