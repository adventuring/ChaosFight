...
HFCM_LeftMomentum
          let temp8 = CharacterMovementSpeed[temp5]
          let playerVelocityX[temp1] = playerVelocityX[temp1] - temp8
          let playerVelocityXL[temp1] = 0
          goto HFCM_LeftFacing
HFCM_LeftDirect
          let temp8 = CharacterMovementSpeed[temp5]
          let playerX[temp1] = playerX[temp1] - temp8
HFCM_LeftFacing
...
HFCM_VertJoy0
          ...
          return
HFCM_VertUp
          if temp5 = 8 then let playerVelocityY[temp1] = playerVelocityY[temp1] - temp8 : return
          if temp5 = 2 then let playerY[temp1] = playerY[temp1] - temp8 : return
          return
HFCM_VertDown
          if temp5 = 8 then let playerVelocityY[temp1] = playerVelocityY[temp1] + temp8 : return
          if temp5 = 2 then let playerY[temp1] = playerY[temp1] + temp8 : return
