...
HFCM_VertUp
          ...
          if temp5 = 8 then let playerVelocityY[temp1] = playerVelocityY[temp1] - characterMovementSpeed : return thisbank

          if temp5 = 2 then let playerY[temp1] = playerY[temp1] - characterMovementSpeed : return thisbank
