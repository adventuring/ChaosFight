...
P1SetPattern
          ...
          let pfscore1 = temp3 : rem Set pfscore1 to health bar pattern
...
P2SetPattern
          ...
          let pfscore2 = temp3 : rem Set pfscore2 to health bar pattern
...
UpdatePlayer12HealthBars
          ...
          let temp1 = playerHealth[0] : rem Update P1 health bar
          gosub UpdatePlayer1HealthBar
          
          let temp1 = playerHealth[1] : rem Update P2 health bar
