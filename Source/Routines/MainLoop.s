...
skip_reset_check:
          ...
          ;; jmp MainLoopContinue (duplicate)
          ...
          ;; jmp MainLoopDrawScreen (duplicate)
...
MainLoopModePublisherPrelude .proc
          ...
          ;; lda # <(return_point-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # >(PublisherPreludeMain-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(PublisherPreludeMain-1) (duplicate)
          ;; pha (duplicate)
                    ;; ldx # 13 (duplicate)
...
MainLoopModeTitleScreen .proc
          ...
          ;; lda # <(return_point-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # >(TitleScreenMain-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(TitleScreenMain-1) (duplicate)
          ;; pha (duplicate)
                    ;; ldx # 13 (duplicate)
...
MainLoopModeCharacterSelect .proc
          ...
          ;; lda # <(return_point-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # >(CharacterSelectInputEntry-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(CharacterSelectInputEntry-1) (duplicate)
          ;; pha (duplicate)
                    ;; ldx # 8 (duplicate)
...
MainLoopModeFallingAnimation
          ...
          ;; lda # <(return_point-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # >(FallingAnimation1-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(FallingAnimation1-1) (duplicate)
          ;; pha (duplicate)
                    ;; ldx # 10 (duplicate)
...
MainLoopModeGameMain .proc
          ...
          cmp ModeGame
          bne skip_2091
          ;; jmp MainLoopModeGameMainContinue (duplicate)
skip_2091:
...
MainLoopModeWinnerAnnouncement .proc
          ...
          ;; lda # <(return_point-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # >(WinnerAnnouncementLoop-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(WinnerAnnouncementLoop-1) (duplicate)
          ;; pha (duplicate)
                    ;; ldx # 11 (duplicate)
...
MainLoopDrawScreen .proc
          ...
          ;; lda # <(return_point-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # >(DrawTitleScreen-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(DrawTitleScreen-1) (duplicate)
          ;; pha (duplicate)
                    ;; ldx # 8 (duplicate)
