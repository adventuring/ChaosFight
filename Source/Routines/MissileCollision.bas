          ...
          rem INPUT:
          rem   currentPlayer = attacker player index (0-3)
...
CheckAllMissileCollisions
          ...
          rem INPUT:
          rem   currentPlayer = attacker participant array index (0-3 maps to participants 1-4, missile owner)
...
CheckVisibleMissileCollision
          ...
          if currentPlayer = 0 then goto SkipSecondParticipant1
...
SkipSecondParticipant1
          ...
          if currentPlayer = 1 then goto SkipSecondParticipant2
...
SkipSecondPlayer1
          ...
          if currentPlayer = 2 then goto SkipSecondParticipant3
...
SkipSecondParticipant3
          ...
          if currentPlayer = 3 then goto SkipSecondParticipant4
...
CheckAOEDirectionRight
          ...
          let temp7 = CharacterAOEOffsets[temp5]
          ...
          rem Check Player 1
          if currentPlayer = 0 then goto SkipAOEPlayer0
...
SkipAOEPlayer0
          ...
          rem Check Player 2
          if currentPlayer = 1 then goto SkipAOEPlayer1
...
SkipAOEPlayer1
          ...
          rem Check Player 3
          if currentPlayer = 2 then goto SkipAOEPlayer2
...
SkipAOEPlayer2
          ...
          rem Check Player 4
          if currentPlayer = 3 then goto SkipAOEPlayer3
...
CheckAOEDirectionLeft
          ...
          rem Check Player 1
          if currentPlayer = 0 then goto CheckPlayer2
...
SkipThirdPlayer1
          ...
          rem Check Player 3
          if currentPlayer = 2 then goto SkipThirdPlayer2
...
SkipThirdPlayer2
          ...
          rem Check Player 4
          if currentPlayer = 3 then goto SkipThirdPlayer3
