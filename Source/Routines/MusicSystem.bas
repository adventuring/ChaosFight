...
LoadSongPointersDone
          ...
          let musicVoice0Pointer = songPointer : rem Set Voice 0 pointer to song start (Song_Voice0 stream)
          let musicVoice0StartPointer_W = songPointer : rem Store initial pointers for looping (Chaotica only)
          ...
          let musicVoice1StartPointer_W = songPointer : rem Store initial Voice 1 pointer for looping (Chaotica only)
...
IsChaotica
          ...
          rem head
          let musicVoice0Pointer = musicVoice0StartPointer_R : rem Reset Voice 0 pointer to start
          let musicVoice1Pointer = musicVoice1StartPointer_R : rem Reset Voice 1 pointer to start
          let musicVoice0Frame_W = 1 : rem Initialize frame counters to trigger first note load
          let musicVoice1Frame_W = 1
