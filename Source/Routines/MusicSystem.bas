...
UpdateMusicVoice0
          ...
          if currentSongID_R < Bank1MinSongID then gosub LoadMusicNote0Bank15 : return thisbank
...
UpdateMusicVoice1
          ...
          if currentSongID_R < Bank1MinSongID then gosub LoadMusicNote1Bank15 : return thisbank
