...
LoadCharacterSprite .proc
          ...
          ;; pha (duplicate)
          ;; lda # >(CopyGlyphToPlayer-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(CopyGlyphToPlayer-1) (duplicate)
          ;; pha (duplicate)
                    ldx # 15
...
;; return_point: (duplicate)
          ...
          ;; lda # <(return_point-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # >(LocateCharacterArt-1) (duplicate)
          ;; pha (duplicate)
          ;; lda # <(LocateCharacterArt-1) (duplicate)
          ;; pha (duplicate)
                    ;; ldx # 8 (duplicate)
...
skip_3862:
          ...
          ;; lda temp1 (duplicate)
          ;; cmp # 16 (duplicate)
          ;; bcs skip_1377 (duplicate)
          ;; jmp goto_label (duplicate)
skip_1377:

          ;; lda temp1 (duplicate)
          ;; cmp # 16 (duplicate)
          ;; bcs skip_5784 (duplicate)
          ;; jmp goto_label (duplicate)
skip_5784:
          ...
          ;; lda temp1 (duplicate)
          ;; cmp # 24 (duplicate)
          ;; bcs skip_6013 (duplicate)
          ;; jmp goto_label (duplicate)
skip_6013:

          ;; lda temp1 (duplicate)
          ;; cmp # 24 (duplicate)
          ;; bcs skip_466 (duplicate)
          ;; jmp goto_label (duplicate)
skip_466:

          
          ;; jmp LoadPlayerSprite_Bank5Dispatch (duplicate)
