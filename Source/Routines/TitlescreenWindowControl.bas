...
SetAuthorWindowValues
          rem Set runtime window values for Author screen (Interworldly visible in slot 4)
          ...
          rem Hides: AtariAge logo (bmp_48x2_1), AtariAgeText (bmp_48x2_2), Interworldly (bmp_48x2_4)
