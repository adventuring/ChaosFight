...
TriggerEliminationEffects
          ...
          rem Off-screen
          if currentPlayer = 0 then let player0x = 200
          if currentPlayer = 1 then let player1x = 200
          rem Player 3 uses player2 sprite (multisprite)
          if currentPlayer = 2 then let player2x = 200
          rem Player 4 uses player3 sprite (multisprite)
          if currentPlayer = 3 then let player3x = 200
