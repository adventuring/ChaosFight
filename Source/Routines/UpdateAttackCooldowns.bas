...
UpdateAttackCooldowns
          ...
          rem Decrements playerAttackCooldown[0-3] timers if > 0.
          rem Input: None
          rem Output: Attack cooldown timers decremented for all players
          rem Mutates: temp1 (0-3), playerAttackCooldown[] (decremented if > 0)
          rem
          ...
          for temp1 = 0 to 3
          let temp2 = playerAttackCooldown[temp1]
          if temp2 = 0 then UpdateAttackCooldownSkip
          let temp2 = temp2 - 1
          let playerAttackCooldown[temp1] = temp2
